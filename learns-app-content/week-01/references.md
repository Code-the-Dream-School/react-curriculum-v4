...
- [index.html and Project Root (Vite docs)](https://vitejs.dev/guide/#index-html-and-project-root)
- [The public directory (Vite docs)](https://vitejs.dev/guide/assets.html#the-public-directory)
